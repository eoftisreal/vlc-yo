...
T.ToolBar {
    ...
    property bool showGlobalToolbar: true
    ...
    height: VLCStyle.applicationVerticalMargin
            ...
            + (showGlobalToolbar ? VLCStyle.globalToolbar_height : 0)
    ...
    contentItem:  Column {
        ...
        property alias model: globalMenuRepeater.model
            ...
            Item {
                id: globalToolbar
                visible: root.showGlobalToolbar
                width: parent.width
                height: visible ? (VLCStyle.globalToolbar_height + (menubar.visible ? menubar.height : 0)) : 0
